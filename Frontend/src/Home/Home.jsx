    ...
    <>
      ...
      <section className="mt-8 bg-white p-6 rounded-lg shadow-lg">
        <div className="flex items-center">
          {/* Principal Image */}
          <div className="w-1/2">
            <img src="collegePrincipal.png" alt="Principal Image" className="w-full h-full object-cover rounded-lg" />
          </div>
          {/* Principal Description */}
          <div className="w-1/2 pl-6">
            <h2 className="text-2xl font-bold mb-2">Dr. John Smith</h2>
      ...
      <main className="flex-grow bg-aqua mt-4">
        <div className="container mx-auto p-6 flex flex-wrap justify-around">
          ...
          <div className="w-full md:w-5/12 bg-white p-6 rounded-lg shadow-lg">
            ...
            <a href="/event" className="block text-center text-blue-600 font-bold hover:bg-gray-100 py-2 border-t border-gray-200 mt-4">View All Upcoming Events</a>
